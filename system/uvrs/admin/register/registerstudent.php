...
<div class="w3-main" style="margin-left:250px;width:1000px;background-color:rgba(255, 255, 255,0.8)">
  ...
  <div class="w3-row w3-padding-64" style = "margin-left:100px">
    ...
    <p>
		...
		<form class="w3-container w3-row-padding" action="student_register_action.php" method = "post">
		<p>
      ...
      <div class="w3-third">
			...
			<input class="w3-input w3-border w3-light-grey" name="matric_no" type="text" required>
    </div></p>
		<p>
