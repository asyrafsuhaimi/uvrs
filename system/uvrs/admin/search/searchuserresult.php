...
<div class="w3-main" style="margin-left:250px;width:1000px;background-color:rgba(255, 255, 255,0.6)")">
  ...
  <div class="w3-row w3-padding-64" style = "margin-left:100px">
      <h1 class="w3-text-teal">System User Information</h1>
    ...
    <tr>
      ...
      <?php
          ...
          ";
      		...
      		$user_results = mysql_query("SELECT * FROM ".$type."
      			...
      			if(strlen($query) >= $min_length)
      			{
                    ...
                    echo "<tr><td>".$uname."</td><td>".$pword."</td><td>
                    	<form action = 'userdetail.php' method = 'post'>
                    	<button class='w3-btn w3-blue-grey' type = 'submit' value =".$uname." name = 'search'>Details</button></p>
                    	</form></td></tr>";
      						}
      					}
      					else
      					{
      							$uname = "No result";
      							$pword = "No result";
                    echo "<tr><td>".$uname."</td><td>".$pword."</td><td></td></tr>";
      					}
      				}
      				else
      				{ 	}
