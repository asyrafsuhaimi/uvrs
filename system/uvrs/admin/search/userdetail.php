...
<div class="w3-main" style="margin-left:250px;width:1000px;background-color:rgba(255, 255, 255,0.6)")">
  ...
  <div class="w3-row w3-padding-64" style = "margin-left:100px">
    <div class="w3-twothird w3-container">
      <p>
		...
		<div class="w3-container w3-theme-l1">
			...
			<form class="w3-container" action="/Asyraf/uvrs/admin/update/editstudent.php" method = "post">
		<p>
			<label class="w3-label w3-text-grey"><b>Username</b></label>
			<div class="w3-container w3-section w3-leftbar w3-border-blue w3-pale-blue">
				<p><?php echo $uname ?></p>
			 </div></p>
		<p>
	...
	<div class = "w3-container" style = "margin-left:30%">
		<form action = "/Asyraf/uvrs/admin/delete/deleteuseraction.php" method = "post">
		<button class="w3-btn w3-blue-grey w3-hover-red" type = "submit" value ="<?php echo $uname ?>" name = "delete" onclick = "return confirm('Are You Sure You Want To Delete?')">Delete Information</button>
		</form>
	</div>
