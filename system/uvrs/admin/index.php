...
<div class="w3-top">
  <ul class="w3-navbar w3-theme w3-top w3-left-align w3-large">
    ...
    <li class="w3-hide-small"><a href="../admin/register/registerstaff.php" class="w3-hover-white">Registration</a></li>
    <li class="w3-hide-small"><a href="../admin/search/searchstaff.php" class="w3-hover-white">Search Info</a></li>
    <li class="w3-hide-small"><a href="../admin/report/staffpiechart.php" class="w3-hover-white">Report</a></li>
...
<div class="w3-animate-opacity w3-content w3-display-container" align = "center" style = "margin-top:30px">
  ...
  <div class="w3-row">
		<div class="w3-container">
			  <img src="images/1.jpg" class="w3-card-4" style="width:400px;height:125px">
		</div>
    <div class="w3-twothird w3-container">
      <h4 class="w3-text-blue">Road Safety Campaign</h4>
    ...
    <div class="w3-twothird w3-container" style = "margin-left:60px">
      <p><h7>Here's Are Some Facts About Seat Belts You Might Didn't Know About :<h7></p>
      ...
      <p><h7>2. Airbags work best if you wear your seat belt. Airbags provide supplemental protection in crashes,
        but motorists can slide under them if they’re not wearing a seat belt. <h7></p>
