...
<nav class="w3-sidenav w3-collapse w3-theme-l5 w3-animate-left" style="z-index:3;width:250px;margin-top:51px;" id="mySidenav">
  ...
  <a href="registeruser.php" class="w3-hover-black">System User Registration</a>
  ...
  <div class="w3-row w3-padding-64" style = "margin-left:100px">
    ...
    <p>
		...
		<div class="w3-container w3-theme-l1">
			<h3>System User Information</h3>
			</div>
		<form class="w3-container w3-row-padding" action="user_register_action.php" method = "post">
		<p>
