...
<div class="w3-main" style="margin-left:250px;width:1000px;background-color:rgba(255, 255, 255,0.6)")">
  ...
  <div class="w3-row w3-padding-64" style = "margin-left:100px">
    <div class="w3-two w3-container">
      <p>
		...
		<div class="w3-container w3-theme-l1">
			...
			<form class="w3-container w3-row-padding" action="/Asyraf/uvrs/admin/update/editstaff.php" method = "post">
        <p>
        ...
        <p>
          <div class="w3-third w3-section">
    			...
    			<input class="w3-input w3-border w3-light-grey" name="phone_no" type="text" value = "<?php echo $phone_no ?>"disabled></div></p>
    		<p>
         <div class="w3-twothird w3-section">
    			<label class="w3-label w3-text-grey"><b>Address</b></label>
    			<input class="w3-input w3-border w3-light-grey" name="address" type="text" value = "<?php echo $address ?>"disabled></div></p>
    		<p>
        <div class="w3-third w3-section">
      			<label class="w3-label w3-text-grey"><b>Responsibility Center</b></label>
            <input class="w3-input w3-border w3-light-grey" name="address" type="text" value = "<?php echo $location ?>"disabled></div></p>
    		<p>
        <div class="w3-third w3-section">
    			<label class="w3-label w3-text-grey"><b>Position</b></label>
          <input class="w3-input w3-border w3-light-grey" name="address" type="text" value = "<?php echo $position ?>"disabled></div></p>
      	<p>
         <div class="w3-third w3-section">
    			<label class="w3-label w3-text-grey"><b>License Number</b></label>
    			<input class="w3-input w3-border w3-light-grey" name="license_no" type="text" value = "<?php echo $license_no ?>"disabled></div></p>
    		<p>
        <div class="w3-third w3-section">
    			<label class="w3-label w3-text-grey"><b>License Validity</b></label>
    			<input class="w3-input w3-border w3-light-grey" name="license_valid" type="date" value = "<?php echo $license_valid ?>"disabled></div></p>
    		<p>
        <div class="w3-third w3-section">
    			<label class="w3-label w3-text-grey"><b>Vehicle Number</b></label>
    			<input class="w3-input w3-border w3-light-grey" name="vehicle_no" type="text" value = "<?php echo $vehicle_no ?>"disabled></div></p>
    		<p>
         <div class="w3-third w3-section">
    			<label class="w3-label w3-text-grey"><b>Road Tax Validity</b></label>
    			<input class="w3-input w3-border w3-light-grey" name="road_tax" type="date" value = "<?php echo $road_tax ?>"disabled></div></p>
    		<p>
         <div class="w3-half w3-section">
    			<label class="w3-label w3-text-grey"><b>Vehicle Ownership</b>
    			<input class="w3-input w3-border w3-light-grey" name="road_tax" type="text" value = "<?php echo $vehicle_ownership ?>"disabled></div></p>
    		<p>
         <div class="w3-half w3-section">
    			<label class="w3-label w3-text-grey"><b>Vehicle Type</b>
	        <input class="w3-input w3-border w3-light-grey" name="road_tax" type="text" value = "<?php echo $vehicle_type ?>"disabled  ></div></p>
    		<p>
			<button class="w3-btn w3-blue-grey" type = "submit" value ="<?php echo $staff_no ?>" name = "search">Edit Information</button>
		</form>
    </div>
	...
	<div class = "w3-container" style = "margin-left:40%">
		<form action = "/Asyraf/uvrs/admin/delete/deletestaffaction.php" method = "post">
		<button class="w3-btn w3-blue-grey w3-hover-red" type = "submit" value ="<?php echo $staff_no ?>"
     name = "delete" onclick = "return confirm('Are You Sure You Want To Delete?')">Delete Information</button>
		</form>
	</div>
