  ...
  <div class="w3-row w3-padding-64" style = "margin-left:100px"	>
    <div class="w3-twothird w3-container">
      ...
      <p>
		...
		<p>
			<label class="w3-label w3-text-grey"><b>Staff Number or Name </b></label>
			<input class="w3-input w3-border w3-light-grey" name="search" type="text"></p>
...
<div class="w3-twothird w3-container ">
  <table class="w3-table-all w3-hoverable w3-card-4 ">
	...
	<form action = "searchresultstaff.php" method = "post">
		<button class="w3-btn w3-blue-grey" type = "submit" value ="<?php echo $staff_no ?>" name = "search" >View Full Information</button></p>
	</form>
</div>
  </div>
