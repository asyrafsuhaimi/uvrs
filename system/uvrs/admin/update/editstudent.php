...
<form class="w3-container w3-row-padding" action="updateactionstudent.php" method = "post">
    ...
    <p>
      ...
      <div class="w3-half w3-section">
		...
		<p>
			<button type = "submit" name = "matric_no" value ="<?php echo $matric_no ?>" onclick = "return confirm('Are You Sure You Want To Update?')" class="w3-btn w3-blue-grey">Update Information</button></p>
			</form>
</div></p>
    </div>
