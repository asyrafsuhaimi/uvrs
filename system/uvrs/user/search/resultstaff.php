...
<div class="w3-main" style="margin-left:250px;width:1000px;background-color:rgba(255, 255, 255,0.6)")">
  ...
  <div class="w3-row w3-padding-64" style = "margin-left:100px"	>
    ...
    <input class="w3-input w3-border w3-padding" type="text" placeholder="Filter for names.." id="myInput" onkeyup="myFunction()">
          ...
          ";
      		...
      		$staff_results = mysql_query("SELECT * FROM staff
      			...
      			if(strlen($query) >= $min_length)
      			{
                    ...
                    echo "<tr><td>".$name."</td><td>".$staff_no."</td><td>".$phone_no."</td><td>
                      <form action = 'searchresultstaff.php' method = 'post'>
                      <button class='w3-btn w3-blue-grey' type = 'submit' value =".$staff_no." name = 'search'>Details</button>
                      </form></td></tr>";
      						}
      					}
      					else
