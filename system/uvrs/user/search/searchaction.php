...
<div class="w3-main" style="margin-left:250px;width:1000px;background-color:rgba(255, 255, 255,0.6)")">
  ...
  <div class="w3-row w3-padding-64" style = "margin-left:100px">
    <div class="w3-twothird w3-container">
      ...
      <p>
		...
		<p>
			<label class="w3-label w3-text-grey"><b>Matric Number or Name</b></label>
  ...
  <table class="w3-table-all w3-hoverable w3-card-4 ">
	...
	<form action = "searchresult.php" method = "post">
		<button class="w3-btn w3-blue-grey" type = "submit" value ="<?php echo $matric_no ?>" name = "search" >View Full Information</button></p>
	</form>
</div>
  </div>
