...
<!DOCTYPE html>
<html>
<title>System User Information</title>
    ...
    <div class="w3-twothird w3-container">
      ...
      <p>
		...
		<div class="w3-container w3-theme-l1">
			<h2>System User Information</h2>
			</div>
			<form class="w3-container" action="searchuserresult.php" method = "post">
		<p>
      ...
      <p>
      <input class="w3-radio" type="radio" name = "type" value = "admin" checked>
      <label class="w3-validate">Admin</label></p>
      <p>
      <input class="w3-radio" type="radio" name = "type" value = "user">
      <label class="w3-validate">Normal User</label></p>
		<p>
